...
const AcceptOwnership = () => {
  return (
    <div className="Accept-ownership flex container m-auto justify-between">
        ...
        <div className="p-5">
          ...
          <div className="flex my-2">
            ...
            <div className="ml-2">
              ...
              <h3 className="text-white font-bold text-3xl">Shadid Reza</h3>
            </div>
          </div>
        </div>
      ...
      <div className="page w-4/5 mx-20">
        ...
        <div className="flex flex-col shadow-lg p-5 rounded bg-slate-100">
          ...
          <form className="flex flex-col items-center">
            ...
            <div className="flex">
              <img className="w-1/2 mx-10 my-5" src={nid} alt="License" />
              <div className="w-1/2 mx-10 my-5">
                <h3 className="text-lg font-bold">Request Form</h3>
                <div className="bg-white w-full h-20 border border-gray-200 shadow-md rounded-md my-5 p-3 text-lg">
                  <p>
                    <span className="font-bold">Name: </span>Boby Mia
                  </p>
                  <p>
                ...
                <input
                  ...
                  className="input input-bordered input-sm rounded w-full mb-5"
                />
                <input
                  type="password"
                ...
                <p className="text-red-400">
                  ...
                  Any changes made after confirmation is unchangeable and your
