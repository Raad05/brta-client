  ...
  return (
    <div className="E-License flex container m-auto justify-between items-center mt-10">
      <div className="bg-three w-1/5 flex flex-col rounded-lg">
        ...
        <Link
          to="/scan-e-license"
          className="bg-four p-3 m-5 rounded font-bold flex items-center text-white"
        >
          <img src={home} className="w-8 mr-4" alt="home" />
          Scan e-license
        </Link>
        <Link className="bg-four hover:bg-gray-600 duration-100 p-3 m-5 rounded font-bold flex items-center bg-white">
